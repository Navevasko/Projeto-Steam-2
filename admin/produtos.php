                            ...
                            <label id="titulo-categoria"> Categorias: </label>
                                ...
                                ?>
                                    <div class="input-categoria">
                                        <input type="checkbox" name="<?=$rsCategorias['nomeCategoria']?>" id="<?=$rsCategorias['nomeCategoria']?>" value="#categoria.<?=$rsCategorias['idcategoria']?>" <?=compararCategoria($id, $rsCategorias['idcategoria'])?>>
                                        <label for="<?=$rsCategorias['nomeCategoria']?>"> <?=$rsCategorias['nomeCategoria']?> </label>
                                    </div>
                                <?php
                                    }
                                ?>
